...
switch ($action) {
   ...
   case 'getcelebrity_wishes':
        getcelebrity_wishes();
        break;

  case 'views_store_homepage':
        views_store_homepage();
        break;
...
function  getcelebrity_wishes(){

    // print_r($_POST);die();
  
    $wishes = new Wishess();
    $data_set = $wishes->getCelebrityWishes();
